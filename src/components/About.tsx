...
export function About() {
  return (
    <section
      id="about"
      className="mx-auto my-14 flex h-full max-w-[80rem] flex-row items-center justify-center gap-12 bg-white px-16 py-0"
    >
      ...
      <div className="max-w-[35rem] pr-6">
        ...
        <p className="text-color5">
          ...
          interfaces, Tailwind CSS for styling, and TypeScript for adding static
          types to JavaScript. I also use Nest.js for building efficient,
          scalable Node.js server-side applications, Supabase as an open source
          Firebase alternative, and Docker for creating, deploying, and running
          applications by using containerization.
        </p>
      </div>
    </section>
  );
